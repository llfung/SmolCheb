classdef PS_RunTime_Svar
    ...
    methods
        function obj = PS_RunTime_Svar(variableDirection,InversionMethod,mats,settings,save_rate1,save_rate2)
        ...
        function obj=RunTimeCall(obj,ucoeff,S_profile,i)
            %RunTimeCall To be called at every time step
            %   Detailed explanation goes here
            %% Saving rate 1 - Transforming
            if obj.InvMeth
            if ( mod(i, obj.saving_rate1) == 0 )
                % Computing g and *_g variables
                if obj.InvMeth
                    [g,Linv]=Linv_g(S_profile,obj.mats.Mvor,obj.mats.Mgyro,obj.mats.Mlap,obj.settings.Mint,obj.Msin,obj.settings.n,obj.settings.m);
                    if ~(mod(obj.InvMeth,2))
                        Linv=gpuArray(Linv);
                    end
                    if obj.varDir==1
                        [obj.Transformed.ex_g,obj.Transformed.ez_g,...
                            ...
                            Linv_f('x',g,Linv,obj.Msin,obj.mats.Rdx,obj.mats.Rd2x,obj.mats.Mp1,obj.mats.Mp3,...
                            obj.settings,zeros(1,obj.settings.N_mesh),obj.settings.n*obj.settings.m/2+obj.settings.m/2+1);
                    else
                        [obj.Transformed.ex_g,obj.Transformed.ez_g,...
                            obj.Transformed.Dxx_g,obj.Transformed.Dxz_g,obj.Transformed.Dzx_g,obj.Transformed.Dzz_g,...
                            obj.Transformed.Vix_g,obj.Transformed.Viz_g,obj.Transformed.VDTx_g,obj.Transformed.VDTz_g,...
                            obj.Transformed.DDTxz_g,obj.Transformed.DDTzz_g]=...
                            Linv_f('z',g,Linv,obj.Msin,obj.mats.Rdz,obj.mats.Rd2z,obj.mats.Mp1,obj.mats.Mp3,...
                            obj.settings,zeros(1,obj.settings.N_mesh),obj.settings.n*obj.settings.m/2+obj.settings.m/2+1);
                    end
                end
                ...
                if obj.varDir==1
                    [ex,ez,Dxx,Dxz,Dzx,Dzz,Vix,Viz,VDTx,VDTz,DDTxx,DDTzx]=...
                        Linv_f('x',f,Linv,obj.Msin,obj.mats.Rdx,obj.mats.Rd2x,obj.mats.Mp1,obj.mats.Mp3,...
                        obj.settings,obj.zero_row,obj.settings.n*obj.settings.m/2+obj.settings.m/2+1);
                    ...
                    [ex,ez,Dxx,Dxz,Dzx,Dzz,Vix,Viz,VDTx,VDTz,DDTxz,DDTzz]=...
                        Linv_f('z',f,Linv,obj.Msin,obj.mats.Rdz,obj.mats.Rd2z,obj.mats.Mp1,obj.mats.Mp3,...
                        obj.settings,obj.zero_row,obj.settings.n*obj.settings.m/2+obj.settings.m/2+1);
