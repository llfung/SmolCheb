...
load('smolbuoy_pBC_0beta_0DT_0Vc_10AR_0.31B_0M_1Vs_1Re_0.01Pef_40Ri_cospi_128cd_12m_16n_0.001dt_0ti_500.002tf.mat')
...
for i=(job_id-1)*500+1:job_id*500
...
zeros(n*m,N_mesh,'gpuArray'),gpuArray(settings.Mint),gpuArray(settings.MintSq),helm,g_trelax);
    ...
    [ex_g,Dxx_g,Vix_g,VDTx_g,DDTx_g]...
