...
%% Setting up
% Parameters
Vc=.02;                       % Swimming Speed (scaled by channel width and Dr) (Pe_s)
...
ucoeff0=zeros(n*m,Nz_mesh*Nx_mesh);%ucoeff0(m*n/2+m/2+1,:)=1/16/pi;
...
ucoeff0(m*n/2+m/2+1,:)=reshape(norm_distrz*norm_distrx/4/pi,[],1);
