...
function  [ex_avg,ez_avg,Dxx_temp,Dzx_temp,Dxz_temp,Dzz_temp,Vix_temp,Viz_temp,...
    VDTx_temp,VDTz_temp,DDTxz_temp,DDTzz_temp]=PS_transformedHS(f,CPUPS)
        d2zf=f*CPUPS.Rd2z;
        dzf=f*CPUPS.Rdz;
%         d2zf=f*CPUPS.Rd2z;
%         dzf=f*CPUPS.Rdz;
...
%         f_swimvari_RHS=CPUPS.Mp1p3*dxf+CPUPS.Mp3sq*dzf-(exz_avg*CPUPS.Rdx+ezz_avg*CPUPS.Rdz).*f;
        ...
        Dxx_temp    =NaN(1,CPUPS.Nz_mesh);
        Dzx_temp    =NaN(1,CPUPS.Nz_mesh);
        Dxz_temp    =NaN(1,CPUPS.Nz_mesh);
        Dzz_temp    =NaN(1,CPUPS.Nz_mesh);
        Vix_temp    =NaN(1,CPUPS.Nz_mesh);
        Viz_temp    =NaN(1,CPUPS.Nz_mesh);
        VDTx_temp   =NaN(1,CPUPS.Nz_mesh);
        VDTz_temp   =NaN(1,CPUPS.Nz_mesh);
%         Vax_temp    =NaN(1,CPUPS.Nz_mesh);
%         Vaz_temp    =NaN(1,CPUPS.Nz_mesh);
        DDTxz_temp  =NaN(1,CPUPS.Nz_mesh);
        DDTzz_temp  =NaN(1,CPUPS.Nz_mesh);
%         DDTxz_temp  =NaN(1,CPUPS.Nz_mesh);
%         DDTzz_temp  =NaN(1,CPUPS.Nz_mesh);
%         Vswimminx_temp=NaN(1,CPUPS.Nz_mesh);
%         Vswimminz_temp=NaN(1,CPUPS.Nz_mesh);
%         Dswimxx_temp=NaN(1,CPUPS.Nz_mesh);
%         Dswimxz_temp=NaN(1,CPUPS.Nz_mesh);
%         Dswimzx_temp=NaN(1,CPUPS.Nz_mesh);
%         Dswimzz_temp=NaN(1,CPUPS.Nz_mesh);
%         Vswimvarx_temp=NaN(1,CPUPS.Nz_mesh);
%         Vswimvarz_temp=NaN(1,CPUPS.Nz_mesh);
        
        
        for j=1:CPUPS.Nz_mesh           
...
%                          dzf(:,j),CPUPS.Mint,CPUPS.MintSq,CPUPS.n,CPUPS.m,CPUPS.dt);
               ...
               f_inhomo=time_relaxed_Linv_f(CPUPS.Mvor,CPUPS.Mgyro,CPUPS.Mlap,CPUPS.S_profile(j),...
                   ...
                   f_DT=time_relaxed_Linv_f(CPUPS.Mvor,CPUPS.Mgyro,CPUPS.Mlap,CPUPS.S_profile(j),...
                         d2zf(:,j),CPUPS.Mint,CPUPS.MintSq,CPUPS.n,CPUPS.m,CPUPS.dt);
