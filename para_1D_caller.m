...
% ex_file_name=['smol_pBC_' num2str(beta) 'beta_' num2str(AR) 'AR_' num2str(Vc) 'Vc_' num2str(Vs) 'Vs_' num2str(1/inv_nu) 'nu_' num2str(DT) 'DT_' num2str(Pef) 'Pef_cospi_cd' num2str(N_mesh) '_m' num2str(m) '_n' num2str(n) '_dt' num2str(dt) '_tf' num2str(tfinal)];
ex_file_name=['smol_pBC_HS_' num2str(beta) 'beta_' num2str(AR) 'AR_' num2str(Vc) 'Vc_' num2str(Vs) 'Vs_' num2str(1/inv_nu) 'nu_' num2str(DT) 'DT_' num2str(Pef) 'Pef_cospi_cd' num2str(N_mesh) '_m' num2str(m) '_n' num2str(n) '_dt' num2str(dt) '_tf' num2str(tfinal)];
% ex_file_name=['smol_rBC_' num2str(beta) 'beta_' num2str(AR) 'AR_' num2str(Vc) 'Vc_' num2str(Vs) 'Vs_' num2str(1/nu) 'nu_'  num2str(DT) 'DT_' num2str(Pef) 'Pef_cospi_cd' num2str(N_mesh) '_m' num2str(m) '_n' num2str(n) '_dt' num2str(dt) '_tf' num2str(tfinal)];
% ex_file_name=['smol_rBC_HS_' num2str(beta) 'beta_' num2str(AR) 'AR_' num2str(Vc) 'Vc_' num2str(Vs) 'Vs_' num2str(1/nu) 'nu_'  num2str(DT) 'DT_' num2str(Pef) 'Pef_cospi_cd' num2str(N_mesh) '_m' num2str(m) '_n' num2str(n) '_dt' num2str(dt) '_tf' num2str(tfinal)];
